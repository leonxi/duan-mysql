...
INSERT INTO `abd_groupsa` (`GROUP_NAME`, `GROUP_FULLNAME`, `GROUP_SUBDOMAIN`, `SA_NAME`, `SA_PREFIX`, `SA_AUTHORIZE`, `VERIFY`, `VERIFYTYPE`, `SETTINGS`, `CREATE_TIME`) VALUES ('短应用', '效吉软件短应用平台', 'www', '访问授权', 'abd', 'AUTHORIZED', 'AUTOVERIFY', 'ORIGIN', NULL, '2018-09-04');
INSERT INTO `abd_groupsa` (`GROUP_NAME`, `GROUP_FULLNAME`, `GROUP_SUBDOMAIN`, `SA_NAME`, `SA_PREFIX`, `SA_AUTHORIZE`, `VERIFY`, `VERIFYTYPE`, `SETTINGS`, `CREATE_TIME`) VALUES ('短应用', '效吉软件短应用平台', 'www', '内建用户登录', 'auo', 'UNAUTHORIZED', 'AUTOVERIFY', 'ORIGIN', NULL, '2019-01-27');
INSERT INTO `abd_groupsa` (`GROUP_NAME`, `GROUP_FULLNAME`, `GROUP_SUBDOMAIN`, `SA_NAME`, `SA_PREFIX`, `SA_AUTHORIZE`, `VERIFY`, `VERIFYTYPE`, `SETTINGS`, `CREATE_TIME`) VALUES ('短应用', '效吉软件短应用平台', 'www', '菜单', 'aad', 'UNAUTHORIZED', 'AUTOVERIFY', 'ORIGIN', NULL, '2018-09-12');
